          ...
          {navigation.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.badge && (
                  <span className="ml-2 px-2 py-1 text-xs font-medium bg-[#ffe600]/20 text-[#ffe600] rounded-full">
                    {item.badge}
                  </span>
                )}
                
                {!active && (
                  <ChevronRightIcon className="ml-2 h-4 w-4 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-200" />
                )}
              </Link>
            );
          })}
